              ...
              <div className="md:flex md:gap-4 ">
                ...
                <div className="py-4 relative flex flex-col justify-start items-center gap-y-2">
                  ...
                  <div className="mobibe w-[58px] h-[106px] md:w-[136px] md:h-[238px] bg-whit absolute rounded-2xl md:rounded-2xl bottom-[68px] right-[1px] md:bottom-[82px] md:right-[1px] z-30">
                    ...
                    <div className="ms:relative sm:w-[60px] sm:h-[107px] z-10">
                      <Image
                        ...
                        width={125}
                        height={225}
                        className="sm:w-[60px] sm:h-[107px] md:w-[125px] md:h-[225px] border border-gray-800 rounded-lg md:rounded-xl absolute bottom-[2px] right-[1px] md:bottom-[8px] md:right-[5px] z-10"
                      />
                    </div>
                  </div>
                  ...
                  {technologies.map((tech, techIndex) => (
                    <li key={techIndex} className="bg-gray-100 flex items-center p-2 border border-gray-300 rounded-xl">
                      <Image className="md:w-[25px] md:h-[25x]" src={`/assets/${tech}-icon.svg`} width={20} height={20} alt={`logo do ${tech}`} /></li>
                  ))}
                  </ul>
                </div>
                <div className="relative flex flex-col text-center md:w-[560px]">
                  ...
                  <div className="md:relative flex items-center">
                    <div className="flex gap-4 pt-2 md:gap-8 md:p-4 text-center md:absolute md:top-[160px] md:left-[55px]  justify-between items-center">
                      <a className="btn flex items-center md:gap-4 bg-gray-400 text-white md:text-lg text-center md:w-[200px] p-[5px] pr-9 md:p-3 rounded-lg md:rounded-xl" target="blanck" href={linkRepositorio.url}>
                        <Image src="/assets/gh-white.svg" alt="" width={30} height={30} />repositorio</a>
                      <a className="btn flex items-center md:gap-8 bg-gray-400 text-white md:text-lg text-center md:w-[200px] p-2 pr-7 md:p-3 rounded-lg md:rounded-xl" target="blanck" href={linkSite.url}>
